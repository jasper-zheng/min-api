...
void doc_generate(const min_class_type& instance, const std::string& refpage_fullpath, const std::string& max_class_name, const std::string& min_class_name)
{
    ...
    refpage_file << endl
                 << endl
                 << "<!-- DO NOT EDIT THIS FILE ... YOU WILL LOSE YOUR WORK -->" << endl
                 << endl;
    refpage_file << endl;
